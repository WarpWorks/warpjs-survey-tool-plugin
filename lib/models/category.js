                ...
                .then((imageDocuments) => Promise.resolve()
                    ...
                    .then((imageEntity) => Promise.resolve()
                        ...
                        .then((subImageRelationship) => Promise.resolve()
                            .then(() => subImageRelationship ? subImageRelationship.getDocuments(persistence, imageDocuments.length ? imageDocuments[0] : {}) : null)
                            .then((subImageDocuments) => Promise.resolve()
                                ...
                                .then((subImageEntity) => Promise.resolve()
                                    .then(() => subImageDocuments && subImageDocuments.length ? new Image(subImageEntity, subImageDocuments[0], imageDocuments.id) : null)
    ...
    toHal(domain, pluginConfig, persistence) {
        return Promise.resolve()
            ...
            .then((resource) => Promise.resolve()
                ...
                .then((questionsHAL) => _.orderBy(questionsHAL, (halQuestion) => {
                    return parseInt(halQuestion.position, 10);
                }))
