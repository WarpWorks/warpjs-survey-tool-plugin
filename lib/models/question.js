...
class Question {
    ...
    toHalRelevance(warpjsUtils, RoutesInfo, routes, domain, resultsetId, resultId) {
        const randomNumber = () => {
        ...
        resource.link('submitFeedback', RoutesInfo.expand(routes.resultQuestionFeedback, {
            domain,
            resutsetId: resultsetId,
            resultId: resultId,
            questionId: this.id
        }));
